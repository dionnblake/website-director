...
current_framework_version = json.loads(read("framework-version.json")).get("version")
check(profile.get("schema_version") == current_framework_version,
...
check("browser_qa" in profile and "measurement" in profile and "security_privacy" in profile
      ...
      and "localization" in profile,
      "V2.6-V2.14 state objects preserved")
