...
**Version:** 2.14.0 (Additive to V2.13.0, V2.12.0, V2.11.1, V2.11.0, V2.10, V2.9, V2.8, V2.7, V2.6, V2.5.1, V2.5, V2.4, V2.3, V2.2, V2.1, V2.0, V1.9, V1.8, V1.7, V1.6, V1.5, V1.4, V1.3.1, V1.3, V1.2, V1.1, and V1). V2.14 integrates Capability 9 Localization and Internationalization at Phase 6.35 without adding a sixth owner lock. Capability 10 Ecommerce, Authentication, and Application Modules remains out of scope.
**System Status:** **`WEBSITE_DIRECTOR_V2_14_LOCALIZATION_INTERNATIONALIZATION_CERTIFIED`**
...
readiness gate and `localization.complete` state. Capability 10 remains out of
scope.
...
8. **Compatibility and stop boundary.** Historical profiles and frozen pilots
   ...
   Ecommerce, Authentication, and Application Modules remains out of scope.
...
Launch Ops, and V2.5 Handoff. Capability 10 Ecommerce, Authentication, and
Application modules remain out of scope.
