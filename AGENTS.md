...
**Version:** 2.13.0 (Additive to V2.12.0, V2.11.1, V2.11.0, V2.10, V2.9, V2.8, V2.7, V2.6, V2.5.1, V2.5, V2.4, V2.3, V2.2, V2.1, V2.0, V1.9, V1.8, V1.7, V1.6, V1.5, V1.4, V1.3.1, V1.3, V1.2, V1.1, and V1). V2.13 integrates Capability 8 Content Operations and CMS Architecture at Phase 6.25 without adding a sixth owner lock. Capability 9 Localization/I18n and Capability 10 Ecommerce, Authentication, and Application Modules remain out of scope.
**System Status:** **`WEBSITE_DIRECTOR_V2_13_CONTENT_OPERATIONS_CMS_CERTIFIED`**
...
is implemented in this checkout. Capability 9 Localization/I18n and Capability
10 Ecommerce, Authentication, and Application modules remain out of scope.
