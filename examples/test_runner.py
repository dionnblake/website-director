...
#
# What this harness proves: the V2.0-V2.14 protocol documents, master templates,
...
KNOWN_SCHEMA_VERSIONS = {
    ...
    '2.6.0', '2.7.0', '2.8.0', '2.9.0', '2.10.0', '2.11.0', '2.11.1', '2.12.0', '2.13.0', '2.14.0',
}
...
def run():
    print('=== WEBSITE DIRECTOR V2.0-V2.14 PROTOCOL, TEMPLATE & PILOT INVARIANT HARNESS ===\n')
    ...
    for obj in ('assets', 'immersive', 'rive', 'page_experience', 'measurement',
                'security_privacy', 'provenance', 'content_ops', 'localization', 'launch_ops'):
